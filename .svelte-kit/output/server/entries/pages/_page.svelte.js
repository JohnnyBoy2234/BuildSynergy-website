...
function Navigation($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<header${attr_class("nav-wrap svelte-ocbj1u", void 0, { "mobile": isMobile })}><nav${attr_class("nav-pill svelte-ocbj1u", void 0, { "collapsed": hideLabels() })} aria-label="Main navigation"><a class="nav-logo-pill svelte-ocbj1u" href="/" aria-label="BuildSynergy Home"><svg class="logo-mark svelte-ocbj1u" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true"><defs><linearGradient id="lgMark" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stop-color="#6366f1"></stop><stop offset="50%" stop-color="#a855f7"></stop><stop offset="100%" stop-color="#22d3ee"></stop></linearGradient></defs><path d="M12 2 L20 9 L12 22 L4 9 Z" stroke="url(#lgMark)" stroke-width="1.4" fill="none" stroke-linejoin="round"></path><path d="M12 6 L17 10 L12 18 L7 10 Z" fill="url(#lgMark)" opacity="0.25"></path><circle cx="12" cy="2" r="1.4" fill="#6366f1"></circle><circle cx="20" cy="9" r="1.1" fill="#a855f7"></circle><circle cx="4" cy="9" r="1.1" fill="#22d3ee"></circle><circle cx="12" cy="22" r="1.2" fill="#22d3ee"></circle></svg> <span${attr_class("logo-text svelte-ocbj1u", void 0, { "logo-hidden": hideLabels() })}>Build<span class="logo-accent svelte-ocbj1u">Synergy</span></span></a> <div class="nav-sep svelte-ocbj1u" aria-hidden="true"></div> <div class="lamp svelte-ocbj1u"${attr_style(`left: ${stringify(lampLeft)}px; width: ${stringify(lampWidth)}px`)} aria-hidden="true"><div class="lamp-bar svelte-ocbj1u"><div class="lamp-bloom lamp-bloom--wide svelte-ocbj1u"></div> <div class="lamp-bloom lamp-bloom--mid svelte-ocbj1u"></div> <div class="lamp-bloom lamp-bloom--tight svelte-ocbj1u"></div></div></div> <!--[-->`);
		...
		$$renderer.push(`<!--]--> <a href="#contact"${attr_class("nav-cta svelte-ocbj1u", void 0, { "cta-icon": hideLabels() || isMobile })}>`);
