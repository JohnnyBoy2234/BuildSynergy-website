    ...
    <div class="pp-body">
      ...
      <section>
        ...
        <ul>
          ...
          <li>Users of websites or systems we manage, where applicable</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <h3>4.1 Identity and Contact Information</h3>
        <ul>
          <li>Full name</li>
          <li>Business name</li>
          ...
          <li>Email address</li>
          <li>Phone number</li>
          <li>Physical address or business location</li>
        </ul>
        <h3>4.2 Business and Project Information</h3>
        <ul>
          <li>Website URL</li>
          <li>Social media links</li>
          <li>Service and business information</li>
          <li>Project details supplied by the Client</li>
          <li>Domain, hosting or technical access details, where required</li>
        </ul>
        <h3>4.3 Billing and Communication Information</h3>
        <ul>
          <li>Billing and payment information</li>
          <li>Information submitted through forms</li>
          <li>Communication records between you and BuildSynergy</li>
        </ul>
        <h3>4.4 Technical Information</h3>
        <ul>
          <li>IP address</li>
          <li>Browser type</li>
        ...
        <p>We do not intentionally collect special personal information unless it is necessary for a specific lawful purpose and the required consent or authority has been provided.</p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Manage legal, accounting and administrative obligations</li>
          <li>Improve our services and website</li>
          <li>Protect our business, systems and Clients</li>
          <li>Comply with applicable laws and regulatory requirements</li>
          <li>Send marketing communications where permitted by law or where consent has been given</li>
        </ul>
      </section>
      ...
      <section>
        <h2>13. Security</h2>
        <p>We take reasonable technical and organisational measures to protect personal information against loss, misuse, unauthorised access, disclosure, alteration or destruction, including access controls, password protection, secure hosting environments, backups, software updates and limited access to information. No electronic system is completely secure and we cannot guarantee absolute security.</p>
      </section>

      <section>
        <h2>14. Security Compromises</h2>
        <p>If we become aware of a confirmed or reasonably suspected security compromise involving personal information under our responsibility, we will take reasonable steps to investigate, contain and respond to the incident. Where required by POPIA, BuildSynergy will notify the Information Regulator and affected data subjects.</p>
      </section>
      ...
      <section>
        ...
        <p>We may send marketing communications where you have opted in, where you are an existing Client, or where permitted by law. You may unsubscribe at any time. We will not sell your contact details to third parties for marketing purposes.</p>
      </section>

      <section>
        <h2>18. Children's Personal Information</h2>
        <p>Our services are intended for businesses and adults. We do not knowingly collect personal information from children without the required consent of a parent, guardian or legally authorised person.</p>
      </section>
      ...
      <section>
        <h2>20. Links to Third-Party Websites</h2>
        <p>Our website or Client websites may contain links to third-party websites. BuildSynergy is not responsible for the privacy practices, security, content or policies of third-party websites. You should review the privacy policy of any third-party website you visit.</p>
      </section>

      <section>
        <h2>21. Updates to This Policy</h2>
        <p>We may update this Privacy Policy from time to time. The latest version will be published on our website with the effective date. Your continued use of our website or services after updates means you accept the updated Privacy Policy.</p>
      </section>
      ...
      <section>
        <h2>23. Information Regulator</h2>
        <p>If you believe your personal information has been processed unlawfully, you may contact the Information Regulator of South Africa.</p>
        <p><strong>Information Regulator of South Africa</strong><br />
        Email: <a href="mailto:enquiries@inforegulator.org.za">enquiries@inforegulator.org.za</a></p>
      </section>
...
<style>
  ...
  .pp-back:hover { color: var(--indigo); }
