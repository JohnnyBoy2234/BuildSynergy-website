		...
		routes: [
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/analytics/_server.ts.js'))
			},
			{
				id: "/api/greeting",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/greeting/_server.ts.js'))
			},
			{
				id: "/api/lead",
				pattern: /^\/api\/lead\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../output/server/entries/endpoints/api/lead/_server.ts.js'))
			}
		],
